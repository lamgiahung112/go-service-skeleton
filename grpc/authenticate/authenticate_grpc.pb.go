...
const (
	AuthenticateService_Authenticate_FullMethodName = "/authenticate.AuthenticateService/Authenticate"
)
...
func (c *authenticateServiceClient) Authenticate(ctx context.Context, in *AuthenticateRequest, opts ...grpc.CallOption) (*AuthenticateResponse, error) {
	...
	err := c.cc.Invoke(ctx, AuthenticateService_Authenticate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
